...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([
            ...
            transforms.ToTensor(),
            transforms.Normalize(mean=mean, std=std),# the mean and std are already scaled(as helper.py) no need to rescale them
    ...
    valid_sampler  = torch.utils.data.SequentialSampler(valid_idx)

...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False, run_logs=False,patience=25):
    ...
    scheduler  = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer=optimizer,patience=patience ,factor=0.5,verbose=True)
    if run_logs:
